 ...
 * [MultiMarkdown](http://fletcherpenney.net/multimarkdown/download/) Required for Markdown-Preview.
 * [TagHighlight](http://www.cgtk.co.uk/vim-scripts/taghighlight), [Tagbar](http://majutsushi.github.com/tagbar/) and [AutoTag](http://www.vim.org/scripts/script.php?script_id=1343) Require a valid installation of Exuberant Ctags in /usr/local/bin
 ...
 * [TagHighlight](http://www.cgtk.co.uk/vim-scripts/taghighlight) - More accurate syntax highlighting for C/C++, Go, Java, etc.
 * [Tagbar](http://majutsushi.github.com/tagbar/) - Display classes layout in a navigable side bar
 * [AutoTag](http://www.vim.org/scripts/script.php?script_id=1343) - Automatically update tags file when saving buffer
 * [a.vim](http://www.vim.org/scripts/script.php?script_id=31) - Easily switch between declaration and definition files
 * [lua.vim](http://peterodding.com/code/vim/lua-ftplugin) - Improve Lua programming

_That's 64 plugins, holy crap._
